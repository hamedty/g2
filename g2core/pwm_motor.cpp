...
#include "pwm_motor.h"
#include "gpio.h"
#define BLOCKED_COUNTER_SMALL 100000
#define BLOCKED_COUNTER_BIG   900000

pwm_motor_t pwm_motors[PWM_MOTOR_COUNT] = {
  { 0, 0, PIOC, 1 << 17, 0, 0, 0 }, // M1 - Step 4 - PC17 - D46
  { 0, 0, PIOC, 1 << 19, 0, 0, 0 }, // M2 - Step 5 - PC19 - D44
  { 0, 0, PIOA, 1 << 19, 0, 0, 0 }, // M3 - Step 6 - PA19 - D42
  { 0, 0, PIOC, 1 << 8, 1, 0, 0  }, // M4 - Step 7 - PC8 - D40
  { 0, 0, PIOC, 1 << 6, 0, 0, 0  }, // M5 - Step 8 - PC6 - D38
  { 0, 0, PIOC, 1 << 4, 0, 0, 0  }, // M6 - Step 9 - PC4 - D36
  { 0, 0, PIOC, 1 << 2, 1, 0, 0  }, // M7 - Step 10 - PC2 - D34
  { 0, 0, PIOD, 1 << 10, 0, 0, 0 }, // M8 - Step 11 - PD10 - D32
  { 0, 0, PIOD, 1 << 9, 0, 0, 0  }, // M9 - Step 12 - PD9 - D30
